...
const InteractiveTerminal = () => {
  const [lines, setLines] = useState([
    ...
    { type: 'output', content: 'jay@developer:~$ Final Year CS Student' },
    { type: 'command', content: '$ ls -la skills/' },
    { type: 'output', content: 'React.js  Node.js  Python  JavaScript  TypeScript' },
    { type: 'command', content: '$ cat passion.txt' },
    { type: 'output', content: 'Building innovative solutions with cutting-edge technology' },
    { type: 'command', content: '$ git status' },
    { type: 'output', content: 'On branch main - Ready to contribute!' },
  ]);
  ...
  return (
    ...
    >
      <div className="terminal-header">
        ...
        <span className="text-sm font-mono text-gray-400 ml-4">jay@developer: ~</span>
        <motion.button
        ...
        >
          ...
          <motion.div variants={itemVariants} className="mb-8">
            <motion.h1 
              ...
              `}
              data-text={cyberMode ? "JAY.EXE" : "Jay Kumar"}
            >
              <span className="text-gradient">
                {cyberMode ? "JAY.EXE" : "Jay Kumar"}
              </span>
            </motion.h1>
          ...
          >
            {cyberMode 
              ? ">>> Initializing neural pathways... Compiling innovative solutions... Ready to hack the future with cutting-edge technology <<<"
              : "Passionate final year Computer Science student crafting innovative digital solutions with modern technologies. Ready to contribute to the next generation of software development."
            }
          </motion.p>
          ...
          >
            ...
            />
            <SocialLink
              href="https://linkedin.com/in/jay"
              icon={Linkedin}
